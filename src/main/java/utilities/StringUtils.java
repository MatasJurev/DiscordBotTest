...
public class StringUtils {
    ...
    public static String stockAsString(Stock stock) {
        ...
        sb.append(quote.getChange()); sb.append("%");
    ...
    public static String dividendString(Stock stock) {
        ...
        sb.append(System.lineSeparator()); sb.append("Annual yield: ");
        sb.append(dividend.getAnnualYield()); sb.append(" (");
    ...
    public static String stockAsStringWithName(Stock stock) {
        ...
        sb.append("-"); sb.append(stock.getName());
        sb.append(" ("); sb.append(stock.getSymbol());
        sb.append("),   price: "); sb.append(quote.getPrice());
        sb.append(" USD,   Daily change: ");
        sb.append(quote.getChange()); sb.append("%");
        return sb.toString();
    }
    ...
    public static String cryptoAsString(Stock crypto) {
        ...
        sb.append("Price: ");
        sb.append(quote.getPrice());
        sb.append(" USD"); sb.append(System.lineSeparator());
        sb.append("Year low: ");
        sb.append(quote.getYearLow()); sb.append(System.lineSeparator());
        sb.append("Year high: ");
        sb.append(quote.getYearHigh()); sb.append(System.lineSeparator());
    ...
    public static String cryptoAsStringWithName(Stock crypto) {
        ...
        sb.append("-"); sb.append(crypto.getName());
        sb.append(",   price: ");
        sb.append(quote.getPrice());
        sb.append(" USD,   Daily change: ");
        sb.append(quote.getChange()); sb.append("%");
